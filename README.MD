...
- `$swt$me` - set test write byte value
    -usage: `&AA$swt$me` sets test byte value to `0xAA`

- `$pwt$me` - set page address to write test values to 

    - usage: `&3F$pwt$me` writes page `0x3F` of test byte value 
